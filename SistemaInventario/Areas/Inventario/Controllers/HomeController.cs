...
namespace SistemaInventario.Areas.Inventario.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(int pageNumber = 1, string busqueda = "", string busquedaActual = "")
        {
            ...
            ViewData["TotalPagina"] = resultado.MetaData.TotalPages;
            ViewData["TotalRegistros"] = resultado.MetaData.TotalCount;
            ViewData["PageSize"] = resultado.MetaData.PageSize;
            ViewData["PageNumber"] = pageNumber;
            ViewData["Previo"] = "disabled"; // clase css para deshabilitar boton
            ViewData["Siguiente"] = "";
        ...
        public async Task<IActionResult> Detalle(int id)
        {
            ...
            carroCompraVM.Producto = await _unidadTrabajo.Producto.ObtenerPrimero(x => x.Id == id,
