        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var carroLista = await _unidadTrabajo.CarroCompra.ObtenerTodos(u => u.UsuarioAplicacionId == usuario.Id);
                ...
                {
                    ModelState.AddModelError(string.Empty, "Usuario no esta registrado o la cuenta no se ha completado.");
                    return Page();
                }
            }
